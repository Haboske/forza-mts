...
<body>
    <header>
        <a href="index.html">
            <img src="images/SVG/logo-white.svg" id="logo" alt="Photo d'un peloton de voitures faisants la course sous la pluie">
        </a>
        <div>
            <a id="news" href="#nouveautes">nouveautés</a>
            <a href="#event">évenements</a>
    ...
    <main>
        ...
        <section class="section_spacing news_section" id="nouveautes">
            <div class="news_intro">
                ...
                <a href="https://forza.net" class="link_to_official">Se rendre sur le site officiel Forza</a>
            </div>
            <div class="news_list">
                <div class="news_item">
                    <div class="news_item_title">
                        ...
                        <p>La première mise à jour du jeu vient d'arriver ! Elle cible principalement des bugs mineur rencontré lors de cette première semaine. Les problèmes de crash rencontrés en mode multijoueur ont pour la plus part été réglé. De plus, les problèmes de textures sur la Ford GT40 et sur la porsche 911 GT2RS ont été résolus.</p>
                    </div>
                ...
                <div class="news_item">
                    <div class="news_item_title">
                        ...
                        <p>Si jamais vous rencontrez des soucis avec le retour de force de votre volant sur Xbox Series, ne vous prenez pas la tête car acune solution n'a été trouvé pour le moment. Il semblerai tout de même que les utilisateurs touché soient principalement ceux ayant précommander la version prenium du jeux.</p>
                    </div>
                    <div class="news_item_linkbox">
                        <a href="#">Lire l'article</a>
                    </div>
    ...
    <footer>
        <section class="section_spacing">
            <div class="footer_div1">
                <img src="images/forza-white.svg" id="logo" alt="Photo en vue macro de goudront représentant la route">
